  ...
  const el = h('div', {
    ...
    h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'space-between', width: '620px' } },
      h('div', { style: { display: 'flex', flexDirection: 'column' } },
        ...
        h('div', { style: { color: '#ffffff', fontSize: '84px', fontWeight: 900, lineHeight: 1.0, letterSpacing: '-3px', marginTop: '8px', display: 'flex' } }, 'ERGÔMETROS'),
        h('div', { style: { color: NEON, fontSize: '84px', fontWeight: 900, lineHeight: 1.0, letterSpacing: '-3px', display: 'flex' } }, 'BRAVE'),
      ),
